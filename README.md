...
*	Update (Edit):
*	Users can click an "Edit" button on any card.
*	A pop-up modal appears, pre-filled with that user's data.
*	When "Save Changes" is clicked, the system deletes the old entry and creates a new, updated entry with the new data (as per your simplified logic).
